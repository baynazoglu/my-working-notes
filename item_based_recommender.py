...
movie = pd.read_csv('DERSLER/RECOMMENDATION SYSTEMS/DATASETS/datasets/movie_lens_dataset/movie.csv')
rating = pd.read_csv('DERSLER/RECOMMENDATION SYSTEMS/DATASETS/datasets/movie_lens_dataset/rating.csv')
...
#pc sıkıntılı oldugu ıcın 10kyı ben tercih ettim.
