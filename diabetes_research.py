...
# 5. Stacking & Ensemble Learning
######################################################
#stacking or ensemble demek birden fazla modelin bir arada kullanmak demek. ensembleı random forestta görmüstük. birden fazla agacın tek agac gıbı gorulme isi.
